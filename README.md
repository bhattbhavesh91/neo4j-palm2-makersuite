...
Learn how to harness the power of Google PaLM 2 Model through Google's Makersuite interface to create an incredible chatbot that helps you ask questions to your Neo4j Database using Natural Language. 

## Click to open the Notebook directly in Google Colab
<!-- [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bhattbhavesh91/neo4j-palm2-makersuite/blob/main/qna-neo4j-palm2-notebook.ipynb)
 -->
 
<a href="https://colab.research.google.com/github/bhattbhavesh91/neo4j-palm2-makersuite/blob/main/qna-neo4j-palm2-notebook.ipynb" target="_blank"><img height="40" alt="Open in Colab" src = "https://colab.research.google.com/assets/colab-badge.svg"></a>

## To view the video

<table>
   <tr>
      <td><a href="http://www.youtube.com/watch?v=tPZ-gGyzGl0" target="_blank"><img height="50" src = "https://img.shields.io/youtube/views/tPZ-gGyzGl0?color=blue&label=Watch%20on%20YouTube&logo=youtube&logoColor=red&style=for-the-badge"></a></td>
   </tr>
</table>
...
[![Palm2
](http://img.youtube.com/vi/tPZ-gGyzGl0/0.jpg)](http://www.youtube.com/watch?v=tPZ-gGyzGl0)
